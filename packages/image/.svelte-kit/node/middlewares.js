...
const prerenderedMiddleware = fs__default.existsSync(paths.prerendered) ? sirv(paths.prerendered, {
  etag: true,
  maxAge: 0,
  gzip: true,
  brotli: true
}) : noop_handler;
const assetsMiddleware = fs__default.existsSync(paths.assets) ? sirv(paths.assets, {
